<x-app-layout title="Edit Jabatan">
    <div class="flex flex-col gap-7">
        ...
        <div
            ...
            <form action="{{ route('admin.jabatan.update', $jabatan->id) }}" class="flex flex-col gap-4" method="POST">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="input-label" class="block mb-2 text-sm font-medium dark:text-white">Nama Jabatan</label>
                    <input type="text" name="name"
                        ...
                        placeholder="Nama Jabatan" value="{{ $jabatan->name }}" disabled readonly>
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="nominal"
                        ...
                        placeholder="100000" value="{{ old('nominal', $jabatan->nominal) }}" required autofocus>
                    @error('nominal')
